<html>
  ...
  <h4 class="alert-heading">As notas foram cadastradas com sucesso!</h4>
  <p>Se quiser cadastrar mais notas, clique em "Voltar".</p>
  <hr>
  <a href="notas.php" class="btn btn-primary">Voltar</a>
</div>  
