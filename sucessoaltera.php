<html>
  ...
  <h4 class="alert-heading">As notas foram alteradas com sucesso</h4>
  <p>Se quiser realizar mais alterações, clique em "Voltar".</p>
  <hr>
  <a href="alteranotas.php" class="btn btn-primary">Voltar</a>
</div>  
