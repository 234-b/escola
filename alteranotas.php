...
<html>
  ...
  Para alterar as notas do aluno, informe a matéria da qual ele faz parte, o código dele, o nome do aluno, as avaliações que deseja mudar e  clique em <strong>"Alterar".</strong>
</div>
         
            <div class="container">
               
                <form method="post" action="altera.php" style="align-items: center">
