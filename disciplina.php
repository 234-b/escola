...
?>
 ...
 <link rel="stylesheet" href="node_modules/bootstrap/compiler/bootstrap.css"> 
  ...
  <strong>Cadastrar Disciplina: </strong>Para cadastrar a disciplina, apenas digite o nome dela e clique em "Cadastrar".
</div>
            <div class="container">
                <form method="post" action="caddisciplina.php" style="align-items: center">
    ...
    <input type="text" class="form-control" name="nome_disc">
  </div>
